...
//
//    private var startRatio: Double = 0 {
//        didSet {
//            setNeedsDisplay()
//        }
//    }
...
//
//        bezierPath.addArc(withCenter: CGPoint(x: rect.width * 0.5, y: rect.height * 0.5), radius: radius, startAngle: CGFloat(startRatio), endAngle: CGFloat(startRatio + 0.1), clockwise: true)
//
//        bezierPath.stroke()
//    }
//
...
//
//        inertiaDisplayLink = ZSLoadViewDisplayLink.zs_displayLink(1, block: { [unowned self] (displayLink) in
